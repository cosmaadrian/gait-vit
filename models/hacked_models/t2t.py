...
def conv_output_size(image_size, kernel_size, stride, padding):
    return int((((image_size[0] - kernel_size[0] + (2 * padding[0])) / stride[0]) + 1)), int((((image_size[1] - kernel_size[1] + (2 * padding[1])) / stride[1]) + 1))
    ...
    def __init__(self, *, image_size, num_classes, dim, depth = None, heads = None, mlp_dim = None, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0., transformer = None, t2t_layers = ((7, 4), (3, 2), (3, 2))):
        ...
        for i, (kernel_size, stride) in enumerate(t2t_layers):
            ...
            layers.extend([
                ...
                nn.Unfold(kernel_size = (kernel_h, kernel_w), stride = (stride_h, stride_w), padding = (stride_h // 2, stride_w // 2)),
        ...
        self.pos_embedding = nn.Parameter(torch.randn(1, output_image_size[0] * output_image_size[1] + 1, dim))
